...
tc filter add dev eth0 parent 1: protocol ip prio 7 u32 flowid 1:7 match ip dst 172.31.34.187/32
tc qdisc add dev eth0 parent 1:7 handle 70: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:8 htb rate 1000mbit
tc filter add dev eth0 parent 1: protocol ip prio 8 u32 flowid 1:8 match ip dst 172.31.40.58/32
tc qdisc add dev eth0 parent 1:8 handle 80: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:9 htb rate 1000mbit
tc filter add dev eth0 parent 1: protocol ip prio 9 u32 flowid 1:9 match ip dst 172.31.43.54/32
...
tc filter add dev eth0 parent 1: protocol ip prio 10 u32 flowid 1:10 match ip dst 172.31.44.132/32
...
tc filter add dev eth0 parent 1: protocol ip prio 11 u32 flowid 1:11 match ip dst 172.31.37.132/32
...
tc filter add dev eth0 parent 1: protocol ip prio 12 u32 flowid 1:12 match ip dst 172.31.42.3/32
