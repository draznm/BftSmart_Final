...
tc filter add dev eth0 parent 1: protocol ip prio 3 u32 flowid 1:3 match ip dst 172.31.46.180/32
tc qdisc add dev eth0 parent 1:3 handle 30: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:4 htb rate 1000mbit
tc filter add dev eth0 parent 1: protocol ip prio 4 u32 flowid 1:4 match ip dst 172.31.37.52/32
tc qdisc add dev eth0 parent 1:4 handle 40: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:5 htb rate 1000mbit
tc filter add dev eth0 parent 1: protocol ip prio 5 u32 flowid 1:5 match ip dst 172.31.34.51/32
tc qdisc add dev eth0 parent 1:5 handle 50: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:6 htb rate 1000mbit
tc filter add dev eth0 parent 1: protocol ip prio 6 u32 flowid 1:6 match ip dst 172.31.40.61/32
