...
tc filter add dev eth0 parent 1: protocol ip prio 7 u32 flowid 1:7 match ip dst 172.31.33.224/32
tc qdisc add dev eth0 parent 1:7 handle 70: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:8 htb
tc filter add dev eth0 parent 1: protocol ip prio 8 u32 flowid 1:8 match ip dst 172.31.45.139/32
tc qdisc add dev eth0 parent 1:8 handle 80: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:9 htb
tc filter add dev eth0 parent 1: protocol ip prio 9 u32 flowid 1:9 match ip dst 172.31.46.135/32
tc qdisc add dev eth0 parent 1:9 handle 90: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:10 htb
tc filter add dev eth0 parent 1: protocol ip prio 10 u32 flowid 1:10 match ip dst 172.31.35.128/32
tc qdisc add dev eth0 parent 1:10 handle 100: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:11 htb
tc filter add dev eth0 parent 1: protocol ip prio 11 u32 flowid 1:11 match ip dst 172.31.46.188/32
tc qdisc add dev eth0 parent 1:11 handle 110: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:12 htb
tc filter add dev eth0 parent 1: protocol ip prio 12 u32 flowid 1:12 match ip dst 172.31.46.183/32
