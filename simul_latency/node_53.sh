...
tc filter add dev eth0 parent 1: protocol ip prio 20 u32 flowid 1:20 match ip src 172.31.32.152/32
...
tc filter add dev eth0 parent 1: protocol ip prio 21 u32 flowid 1:21 match ip src 172.31.38.23/32
...
tc filter add dev eth0 parent 1: protocol ip prio 22 u32 flowid 1:22 match ip src 172.31.36.151/32
...
tc filter add dev eth0 parent 1: protocol ip prio 23 u32 flowid 1:23 match ip src 172.31.39.31/32
...
tc filter add dev eth0 parent 1: protocol ip prio 24 u32 flowid 1:24 match ip src 172.31.32.31/32
...
tc filter add dev eth0 parent 1: protocol ip prio 25 u32 flowid 1:25 match ip src 172.31.35.102/32
...
tc filter add dev eth0 parent 1: protocol ip prio 26 u32 flowid 1:26 match ip src 172.31.34.226/32
...
tc filter add dev eth0 parent 1: protocol ip prio 27 u32 flowid 1:27 match ip src 172.31.39.226/32
...
tc filter add dev eth0 parent 1: protocol ip prio 28 u32 flowid 1:28 match ip src 172.31.45.226/32
...
tc filter add dev eth0 parent 1: protocol ip prio 29 u32 flowid 1:29 match ip src 172.31.39.245/32
...
tc filter add dev eth0 parent 1: protocol ip prio 30 u32 flowid 1:30 match ip src 172.31.42.113/32
...
tc filter add dev eth0 parent 1: protocol ip prio 32 u32 flowid 1:32 match ip src 172.31.44.232/32
...
tc filter add dev eth0 parent 1: protocol ip prio 33 u32 flowid 1:33 match ip src 172.31.36.253/32
...
tc filter add dev eth0 parent 1: protocol ip prio 34 u32 flowid 1:34 match ip src 172.31.37.251/32
...
tc filter add dev eth0 parent 1: protocol ip prio 35 u32 flowid 1:35 match ip src 172.31.41.248/32
...
tc filter add dev eth0 parent 1: protocol ip prio 36 u32 flowid 1:36 match ip src 172.31.34.117/32
...
tc filter add dev eth0 parent 1: protocol ip prio 37 u32 flowid 1:37 match ip src 172.31.36.67/32
...
tc filter add dev eth0 parent 1: protocol ip prio 38 u32 flowid 1:38 match ip src 172.31.42.194/32
...
tc filter add dev eth0 parent 1: protocol ip prio 39 u32 flowid 1:39 match ip src 172.31.38.192/32
...
tc filter add dev eth0 parent 1: protocol ip prio 40 u32 flowid 1:40 match ip src 172.31.34.125/32
...
tc filter add dev eth0 parent 1: protocol ip prio 41 u32 flowid 1:41 match ip src 172.31.45.76/32
...
tc filter add dev eth0 parent 1: protocol ip prio 42 u32 flowid 1:42 match ip src 172.31.47.74/32
...
tc filter add dev eth0 parent 1: protocol ip prio 43 u32 flowid 1:43 match ip src 172.31.35.199/32
...
tc filter add dev eth0 parent 1: protocol ip prio 44 u32 flowid 1:44 match ip src 172.31.37.67/32
...
tc filter add dev eth0 parent 1: protocol ip prio 45 u32 flowid 1:45 match ip src 172.31.40.218/32
...
tc filter add dev eth0 parent 1: protocol ip prio 46 u32 flowid 1:46 match ip src 172.31.35.84/32
...
tc filter add dev eth0 parent 1: protocol ip prio 47 u32 flowid 1:47 match ip src 172.31.45.83/32
...
tc filter add dev eth0 parent 1: protocol ip prio 48 u32 flowid 1:48 match ip src 172.31.43.80/32
...
tc filter add dev eth0 parent 1: protocol ip prio 49 u32 flowid 1:49 match ip src 172.31.36.44/32
...
tc filter add dev eth0 parent 1: protocol ip prio 50 u32 flowid 1:50 match ip src 172.31.32.40/32
...
tc filter add dev eth0 parent 1: protocol ip prio 51 u32 flowid 1:51 match ip src 172.31.41.163/32
...
tc filter add dev eth0 parent 1: protocol ip prio 52 u32 flowid 1:52 match ip src 172.31.40.163/32
...
tc filter add dev eth0 parent 1: protocol ip prio 53 u32 flowid 1:53 match ip src 172.31.47.179/32
