...
tc filter add dev eth0 parent 1: protocol ip prio 13 u32 flowid 1:13 match ip src 172.31.34.131/32
...
tc filter add dev eth0 parent 1: protocol ip prio 14 u32 flowid 1:14 match ip src 172.31.45.144/32
...
tc filter add dev eth0 parent 1: protocol ip prio 15 u32 flowid 1:15 match ip src 172.31.46.143/32
...
tc filter add dev eth0 parent 1: protocol ip prio 16 u32 flowid 1:16 match ip src 172.31.42.14/32
...
tc filter add dev eth0 parent 1: protocol ip prio 17 u32 flowid 1:17 match ip src 172.31.45.14/32
...
tc filter add dev eth0 parent 1: protocol ip prio 18 u32 flowid 1:18 match ip src 172.31.34.155/32
...
tc filter add dev eth0 parent 1: protocol ip prio 19 u32 flowid 1:19 match ip src 172.31.32.152/32
