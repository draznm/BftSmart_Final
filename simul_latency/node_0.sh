...
tc filter add dev eth0 parent 1: protocol ip prio 1 u32 flowid 1:1 match ip dst 172.31.32.233/32
tc qdisc add dev eth0 parent 1:1 handle 10: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:2 htb
tc filter add dev eth0 parent 1: protocol ip prio 2 u32 flowid 1:2 match ip dst 172.31.34.233/32
tc qdisc add dev eth0 parent 1:2 handle 20: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:3 htb
tc filter add dev eth0 parent 1: protocol ip prio 3 u32 flowid 1:3 match ip dst 172.31.35.232/32
tc qdisc add dev eth0 parent 1:3 handle 30: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:4 htb
tc filter add dev eth0 parent 1: protocol ip prio 4 u32 flowid 1:4 match ip dst 172.31.45.230/32
tc qdisc add dev eth0 parent 1:4 handle 40: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:5 htb
tc filter add dev eth0 parent 1: protocol ip prio 5 u32 flowid 1:5 match ip dst 172.31.43.226/32
tc qdisc add dev eth0 parent 1:5 handle 50: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:6 htb
tc filter add dev eth0 parent 1: protocol ip prio 6 u32 flowid 1:6 match ip dst 172.31.39.98/32
