...
tc filter add dev eth0 parent 1: protocol ip prio 55 u32 flowid 1:55 match ip dst 172.31.45.207/32
...
tc filter add dev eth0 parent 1: protocol ip prio 56 u32 flowid 1:56 match ip dst 172.31.41.76/32
