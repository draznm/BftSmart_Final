...
tc filter add dev eth0 parent 1: protocol ip prio 1 u32 flowid 1:1 match ip dst 172.31.34.225/32
tc qdisc add dev eth0 parent 1:1 handle 10: netem delay 0.0ms

tc class add dev eth0 parent 1: classid 1:2 htb rate 1000mbit
tc filter add dev eth0 parent 1: protocol ip prio 2 u32 flowid 1:2 match ip dst 172.31.47.53/32
