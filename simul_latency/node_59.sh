...
tc filter add dev eth0 parent 1: protocol ip prio 57 u32 flowid 1:57 match ip dst 172.31.44.82/32
...
tc filter add dev eth0 parent 1: protocol ip prio 58 u32 flowid 1:58 match ip dst 172.31.46.209/32
...
tc filter add dev eth0 parent 1: protocol ip prio 59 u32 flowid 1:59 match ip dst 172.31.37.89/32
