...
tc filter add dev eth0 parent 1: protocol ip prio 43 u32 flowid 1:43 match ip dst 172.31.42.180/32
...
tc filter add dev eth0 parent 1: protocol ip prio 44 u32 flowid 1:44 match ip dst 172.31.46.176/32
...
tc filter add dev eth0 parent 1: protocol ip prio 45 u32 flowid 1:45 match ip dst 172.31.32.176/32
...
tc filter add dev eth0 parent 1: protocol ip prio 46 u32 flowid 1:46 match ip dst 172.31.36.131/32
...
tc filter add dev eth0 parent 1: protocol ip prio 47 u32 flowid 1:47 match ip dst 172.31.41.131/32
...
tc filter add dev eth0 parent 1: protocol ip prio 48 u32 flowid 1:48 match ip dst 172.31.36.189/32
...
tc filter add dev eth0 parent 1: protocol ip prio 49 u32 flowid 1:49 match ip dst 172.31.39.59/32
...
tc filter add dev eth0 parent 1: protocol ip prio 50 u32 flowid 1:50 match ip dst 172.31.39.7/32
...
tc filter add dev eth0 parent 1: protocol ip prio 51 u32 flowid 1:51 match ip dst 172.31.43.7/32
...
tc filter add dev eth0 parent 1: protocol ip prio 52 u32 flowid 1:52 match ip dst 172.31.37.7/32
...
tc filter add dev eth0 parent 1: protocol ip prio 53 u32 flowid 1:53 match ip dst 172.31.32.133/32
...
tc filter add dev eth0 parent 1: protocol ip prio 54 u32 flowid 1:54 match ip dst 172.31.37.22/32
...
tc filter add dev eth0 parent 1: protocol ip prio 55 u32 flowid 1:55 match ip dst 172.31.35.21/32
tc qdisc add dev eth0 parent 1:55 handle 550: netem delay 11.0ms

tc class add dev eth0 parent 1: classid 1:56 htb rate 1000mbit
tc filter add dev eth0 parent 1: protocol ip prio 56 u32 flowid 1:56 match ip dst 172.31.45.7/32
...
tc filter add dev eth0 parent 1: protocol ip prio 57 u32 flowid 1:57 match ip dst 172.31.47.135/32
...
tc filter add dev eth0 parent 1: protocol ip prio 58 u32 flowid 1:58 match ip dst 172.31.35.158/32
tc qdisc add dev eth0 parent 1:58 handle 580: netem delay 11.0ms

tc class add dev eth0 parent 1: classid 1:59 htb rate 1000mbit
tc filter add dev eth0 parent 1: protocol ip prio 59 u32 flowid 1:59 match ip dst 172.31.43.24/32
