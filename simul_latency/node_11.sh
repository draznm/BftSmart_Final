...
tc qdisc add dev eth0 parent 18:18 handle 180: netem delay 65.0ms
...
tc qdisc add dev eth0 parent 36:36 handle 360: netem delay 65.0ms
...
tc qdisc add dev eth0 parent 51:51 handle 510: netem delay 65.0ms
...
tc qdisc add dev eth0 parent 54:54 handle 540: netem delay 65.0ms
