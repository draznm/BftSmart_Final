...
tc filter add dev eth0 parent 1: protocol ip prio 11 u32 flowid 1:11 match ip src 172.31.37.132/32
...
tc filter add dev eth0 parent 1: protocol ip prio 12 u32 flowid 1:12 match ip src 172.31.42.3/32
